...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        $file = new stdClass();
        $file->name = iconv("gbk","utf-8",$this->trim_file_name($name, $type, $index, $content_range));
    ...
    public function post($print_response = true) {
        ...
        if ($upload && is_array($upload['tmp_name'])) {
            ...
            foreach ($upload['tmp_name'] as $index => $value) {
            	$upload['tmp_name'][$index] = iconv("utf-8","gbk",$upload['tmp_name'][$index]);
            	$upload['name'][$index] = iconv("utf-8","gbk",$upload['name'][$index]);
            ...
            $upload['tmp_name'] = iconv("utf-8","gbk",$upload['tmp_name']);
            $upload['name'] = iconv("utf-8","gbk",$upload['name']);
            $files[] = $this->handle_file_upload(
